...
//Checking of Password field
function checkPassword() {
    var pswd = document.getElementById("pswd").value;
    var regex = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,20}$/;

    if (regex.test(pswd)) { // if testing of first is true
        document.getElementById("pswd_Check").style.color = "green";
        document.getElementById("pswd_Check").innerHTML = "";
        return true;
    }
    else {// if it's not
        document.getElementById("pswd_Check").style.color = "red";
        document.getElementById("pswd_Check").innerHTML = "Please, enter 6-20 characters";
        return false;
    }
}

//Checking of Password repetition
function check(){
    var pswd = document.getElementById("pswd").value;
    var pswd2 = document.getElementById('pswd2').value;

    if (pswd == pswd2) {
        document.getElementById("pswd_check_2").style.color = "green";
        document.getElementById("pswd_check_2").innerHTML = "";
        return true;
    }
    else {
        document.getElementById("pswd_check_2").style.color = "red";
        document.getElementById("pswd_check_2").innerHTML = "Passwords don't match";
        return false;
    }
}
...
active_tab = 0
    ...
    function change_tab(tab_num) {
        document.getElementById(tabs[active_tab][0]).setAttribute("class", "tab_button_small nav-link")
        document.getElementById(tabs[active_tab][1]).setAttribute("class", "tab-pane fade")

        document.getElementById(tabs[tab_num][0]).setAttribute("class", "tab_button_small nav-link active")
        document.getElementById(tabs[tab_num][1]).setAttribute("class", "tab-pane fade show active")
        active_tab = tab_num
    }
    active_tarif = 0
    trifs = ['tarif_1', 'tarif_2', 'tarif_3']

    function choose_tarif(tab_num) {
        document.getElementById(trifs[active_tarif]).classList.remove("tab_active")

        document.getElementById(trifs[tab_num]).classList.add("tab_active")
        active_tarif = tab_num
    }
